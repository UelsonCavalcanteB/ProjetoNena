...
procedure TfmCadCnpj.ButBuscarClick(Sender: TObject);
var
  I: Integer;
begin
  dm.Fornecedor.Open;
  ...
  begin
    ...
    begin
      ...
      dm.FornecedorNOME.Value := ACBrConsultaCNPJ1.RazaoSocial;
      dm.FornecedorNOME_FANTASIA.Value := ACBrConsultaCNPJ1.Fantasia;
...
procedure TfmCadCnpj.EditCaptchaKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
    ButBuscarClick(ButBuscar);
end;

procedure TfmCadCnpj.FormShow(Sender: TObject);
begin
  Timer1.Enabled:= True;
end;

procedure TfmCadCnpj.LabAtualizarCaptchaClick(Sender: TObject);
var
...
procedure TfmCadCnpj.Timer1Timer(Sender: TObject);
begin
